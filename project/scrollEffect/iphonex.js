...
(function () {
  ...
  elemVideo = document.getElementById('video-enzo');
  ...
  calcAnimationValue = (values) => (relativeScrollY / pixelDuration) * (values[1] - values[0]) + values[0];
